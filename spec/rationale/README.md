...
| File | Covers |
|------|--------|
| [01-type-system.md](./01-type-system.md) | §1 — Type System (Rules 1.1–1.9) |
| [02-immutability.md](./02-immutability.md) | §2 — Immutability (Rules 2.1–2.4) |
...
| [06-effects.md](./06-effects.md) | §6 — Effect Management (Rules 6.1–6.5) |
| [08-totality-and-proof.md](./08-totality-and-proof.md) | §8 — Partiality, Totality, and Proof (Rules 8.1–8.3) |
| [09-tooling.md](./09-tooling.md) | §9 — Compiler and Tooling (Rules 9.1–9.5) |
