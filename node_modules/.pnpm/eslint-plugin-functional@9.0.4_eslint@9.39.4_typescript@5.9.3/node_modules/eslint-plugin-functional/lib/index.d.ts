...
import { ESLint, Linter, Rule as EslintRule } from 'eslint';
...
type Rule<MessageIds extends string, Options extends ReadonlyArray<unknown>> = EslintRule.RuleModule & RuleModule<MessageIds, Options, Docs> & {
...
declare const functional: ESLint.Plugin;
