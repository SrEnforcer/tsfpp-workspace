...
Any deviation from a **MUST** rule in `spec/CODING_STANDARD.md` that applies
...
See §Deviation Procedure in `spec/CODING_STANDARD.md` for the full process.
...
| Scope        | `packages/prelude/src/vendor.d.ts` |
| Status       | superseded |
