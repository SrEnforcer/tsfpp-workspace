...
- **[CODING_STANDARD.md](./CODING_STANDARD.md)** — The complete rule set with all MUST, SHOULD, and MAY constraints.
...
- **Ramda** — A functional utility library. TSF++ references curried combinators; Ramda is a popular source.
