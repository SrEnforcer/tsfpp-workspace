...
# TSF++ AI layout
# `.github/` is the committed deliverable and is regenerated by @tsfpp/agents.
# `.ai/` is the same content in the tool-agnostic layout — a local build
# artifact, not something to review or commit.
.ai/
GITIGNORE
  ok ".gitignore"
else
